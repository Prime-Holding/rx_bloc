...
///[InputDecorationData] is a class which defines some additional
///input decoration not present in the [InputDecoration] class
///intended to be used with [RxTextFormField] which internally
...
class RxInputDecorationData {
  ...
  ///when [RxTextFormFieldBuilder] doesn't detect an error
  final TextStyle labelStyle;

  ///the label style used when it is above the field
  ///when [RxTextFormFieldBuilder] detects an error
...
///the one provided by RxTextFormField easier
