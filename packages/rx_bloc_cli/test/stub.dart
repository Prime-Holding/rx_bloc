...
final class Stub {
  ...
  static const overwrittenLoginFiles = [
    'test/feature_login/view/ci/dark_theme/login_empty.png',
    'test/feature_login/view/ci/dark_theme/login_error.png',
    'test/feature_login/view/ci/dark_theme/login_filled.png',
    'test/feature_login/view/ci/dark_theme/login_loading.png',
    'test/feature_login/view/ci/dark_theme/login_success.png',
    'test/feature_login/view/ci/light_theme/login_empty.png',
    'test/feature_login/view/ci/light_theme/login_error.png',
    'test/feature_login/view/ci/light_theme/login_filled.png',
    'test/feature_login/view/ci/light_theme/login_loading.png',
    'test/feature_login/view/ci/light_theme/login_success.png'
  ];
