...
@immutable
class LoginRoute extends GoRouteData with $LoginRoute implements RouteDataModel {
  const LoginRoute();
...
@immutable
class OtpRoute extends GoRouteData with $OtpRoute implements RouteDataModel {
  const OtpRoute();
...
@immutable
class VerifyPinCodeRoute extends GoRouteData with $VerifyPinCodeRoute implements RouteDataModel {
