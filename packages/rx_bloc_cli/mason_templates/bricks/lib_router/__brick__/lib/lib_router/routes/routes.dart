...
@immutable
class SplashRoute extends GoRouteData with $SplashRoute implements RouteDataModel {
  const SplashRoute();
...
@immutable
class DashboardRoute extends GoRouteData with $DashboardRoute implements RouteDataModel {
