...
import 'network_lookup/profile_lookup.dart';{{#enable_feature_qr_scanner}}
...
{{/enable_login}}{{#enable_mfa}}
  ...
  @override
  I18nLibRouterLookup createLibRouterLookup() => AppI18nLibRouterLookup();{{#enable_feature_qr_scanner}}
