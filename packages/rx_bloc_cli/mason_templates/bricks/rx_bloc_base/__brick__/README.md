...
19. [Feature Pin Code](#feature-pin-code){{/enable_pin_code}}{{#enable_tfa}}
20. [Two-Factor Authentication](#two-factor-authentication){{/enable_tfa}}
...
The `lib_tfa` brick contains classes, repositories, data sources and widgets that can help you with building a Two-Factor Authentication workflow for your app. Follow the [technical specification][rx_bloc_cli_tfa_lnk] for information.{{/enable_tfa}}
{{#cicd}}
## CI/CD
