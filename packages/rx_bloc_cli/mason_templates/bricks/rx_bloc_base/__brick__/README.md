...
13. [Social Logins](#social-logins-library){{/enable_social_logins}}{{#enable_patrol}}
14. [Patrol integration tests](#patrol-integration-tests){{/enable_patrol}}{{#realtime_communication}}
15. [Realtime communication](#realtime-communication){{/realtime_communication}}
