...
@immutable
class ShowcaseRoute extends GoRouteData with $ShowcaseRoute implements RouteDataModel {
  const ShowcaseRoute();
...
@immutable
class CounterRoute extends GoRouteData with $CounterRoute implements RouteDataModel {
  const CounterRoute();
...
@immutable
class WidgetToolkitRoute extends GoRouteData with $WidgetToolkitRoute implements RouteDataModel {
...
@immutable
class DeepLinksRoute extends GoRouteData with $DeepLinksRoute implements RouteDataModel {
...
@immutable
class DeepLinkDetailsRoute extends GoRouteData with $DeepLinkDetailsRoute implements RouteDataModel {
...
@immutable
class EnterMessageRoute extends GoRouteData with $EnterMessageRoute implements RouteDataModel {
...
@immutable
class QrCodeRoute extends GoRouteData with $QrCodeRoute implements RouteDataModel {
  const QrCodeRoute();
...
@immutable
class FeatureOtpRoute extends GoRouteData with $FeatureOtpRoute implements RouteDataModel {
...
@immutable
class NotificationsRoute extends GoRouteData with $NotificationsRoute implements RouteDataModel {
