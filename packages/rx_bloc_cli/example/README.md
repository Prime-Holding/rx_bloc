...
| lib/lib_dev_menu                           | A library that helps application debugging by easily setting and accessing proxy debugging (Charles) and in-app HTTP logs ([Talker][talker_pkg_lnk]).                                 |
