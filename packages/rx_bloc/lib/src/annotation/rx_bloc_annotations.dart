...
class RxBlocIgnoreState {
  /// Annotating a state with @RxBlocIgnoreState() will make the generator
  /// ignore it and not generate any underlying boilerplate code for it.
  ///
  /// This annotation allows for more flexibility in defining custom states that
  /// may not fit the standard patterns generated by the RxBloc generator.
