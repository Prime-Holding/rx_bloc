...
/// TODO: Remove _EventArgsRecord class after code migration
...
class _EventArgsRecord2 {
  const _EventArgsRecord2(this.method);
  ...
  Map<String, Reference> _namedArguments({bool invocation = false}) {
    ...
    for (var param in params) {
      ...
      namedArguments[paramName] =
          invocation ? refer(paramName) : refer(param.getTypeDisplayName());
    }
