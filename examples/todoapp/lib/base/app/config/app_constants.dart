...
import 'is_in_test_mode_io_not_available.dart' if (dart.library.io) 'is_in_test_mode_io_available.dart' if (dart.library.html) 'is_in_test_mode_io_not_available.dart';

const String webVapidKey = '';

bool isInTestMode = isInTestModePlatformSpecific;
