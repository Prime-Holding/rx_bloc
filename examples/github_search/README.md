...
```
    ...
    <array>
        ...
        <string>githubsearch.primeholding.com</string>
...
Production
```
xcrun simctl openurl booted primeholdingscheme://githubsearch.primeholding.com/deepLinks/1
```

UAT
```
xcrun simctl openurl booted primeholdinguatscheme://githubsearchuat.primeholding.com/deepLinks/1
```

SIT
```
xcrun simctl openurl booted primeholdingsitscheme://githubsearchsit.primeholding.com/deepLinks/1
```

Development
```
xcrun simctl openurl booted primeholdingdevscheme://githubsearchdevelopment.primeholding.com/deepLinks/1
```
