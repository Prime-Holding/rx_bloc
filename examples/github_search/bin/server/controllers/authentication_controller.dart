...
class AuthenticationController extends ApiController {
  ...
  AuthToken _issueNewToken(String? refreshToken) {
    if (refreshToken != null) {
      final tkn = _authTokenRepository.getTokenViaRefreshToken(refreshToken);
      if (tkn == null) throw BadRequestException('Invalid refresh token!');
      _authTokenRepository.removeToken(tkn.token);
    }
