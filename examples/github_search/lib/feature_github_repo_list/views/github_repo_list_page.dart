...
class GithubRepoListPage extends StatelessWidget implements AutoRouteWrapper {
  ...
  Widget _buildDataContainer() => RxPaginatedBuilder<GithubRepoListBlocType,
        ...
        buildError: (context, list, bloc) => AppErrorWidget(error: list.error!),
      );

  Widget _buildErrorListener() =>
      RxBlocListener<GithubRepoListBlocType, String>(
